...
public class PlayerTorsoLean : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        bool camUp = CamcorderUp;
        if (camUp) _frozenLean = camcorderMotor.CurrentTilt * leanFactor;
        float targetWeight = camUp ? 1f : 0f;
        ...
        float leanAngle = _frozenLean * _weight;
